...
<section class="terms">
    ...
    <div class="content">
        ...
        <p>1. When you complete your Booking, you accept these Terms and any other terms that you’re provided with
            ...
            4. The English version of these Terms is the original. If there’s any dispute about the Terms,
        ...
        <p>Our Platform:
            ...
            2. Our Platform is not a recommendation or endorsement of any Service Provider or its products, services,
            facilities, vehicles, etc.

            3. We’re not a party to the terms between you and the Service Provider. The Service Provider is solely
            responsible for the Travel Experience.

            4. To make a Booking, you may need to create an Account. Please make sure all your info (including payment
            ...
            and please keep your username and password secret.

            5. We will show you the offers that are available to you, in (what we think is) the right language for you.
            You can change to another language whenever you like.

            6. Unless otherwise indicated, you need to be at least 16 to use the Platform.</p>
